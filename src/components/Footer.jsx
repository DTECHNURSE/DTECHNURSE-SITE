        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md text-sm leading-relaxed">
              {content?.tagline || 'Empowering nurses with the technology skills needed to revolutionize healthcare. Bridging the gap between clinical expertise and digital innovation.'}
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex gap-4 text-gray-400">
              <a href={content?.twitterUrl || '#'} aria-label="Twitter" className="hover:text-brand-cyan transition-colors"><Twitter size={20} /></a>
              <a href={content?.linkedinUrl || '#'} aria-label="LinkedIn" className="hover:text-brand-cyan transition-colors"><Linkedin size={20} /></a>
              <a href={content?.githubUrl || '#'} aria-label="GitHub" className="hover:text-brand-cyan transition-colors"><Github size={20} /></a>
            </div>
          </div>
        </div>
